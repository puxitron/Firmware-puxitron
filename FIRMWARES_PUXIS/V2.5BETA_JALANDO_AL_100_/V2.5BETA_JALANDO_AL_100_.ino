...
//  str+=".jpg";
//  str.toCharArray(BUFFER_CONTADOR,9);
  ...
  delay(20);                                //TIEMPO DE ESPERA DESPUES DE ENVIAR UN COMANDO A LA CAMARA
   ...
   CAM= SD.open("66.jpg", FILE_WRITE);   //ABRE LA SD CREA Y ESCRIBE SOBRE EL ARCHIVO
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      WIFI.println(F("AT+CIPSTO=4"));                                   //CIERRA EL SOCKET DESPUES DE 3SEG DE INACTIVIDAD          
       delay(500);
        while(Serial.available()) {
          Serial.write(Serial.read());
                                        }                                                                                                                                            
