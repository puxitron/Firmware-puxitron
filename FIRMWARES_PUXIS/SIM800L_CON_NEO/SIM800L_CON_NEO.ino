...
//////////////////////////////////////////////////////////////////////////////
  ...
  //SIM800.println("AT+CMGD=1,4");          //BORRA LA MEMORIA DONDE ESTAN LOS MENSAJES
  //delay(4000);
...
void SETUP_800() {
  ...
  /*   SIM800.println("AT+SAPBR=3,1,\"CONTYPE\",\"GPRS\"");              //
   delay(500);
     ...
     SIM800.println("AT+SAPBR=3,1,\"APN\",\"internet.itelcel.com\"");     //
   delay(500);

     SIM800.println("AT+SAPBR=3,1,\"USER\",\"webgprs\"");                  //
   delay(500);

     SIM800.println("AT+SAPBR=3,1,\"PWD\",\"webgprs2003\"");               //
   delay(500);
...
void SERVER_TCP() {
  ...
  SIM800.println("AT+CIPSERVER=1,666");                    //
  delay(4000);
