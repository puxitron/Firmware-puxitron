...
//int SEND;
  ...
  delay(600);                                                                                                       
   ...
   JSON_3DATOS=JSON_BASE1+IMEI.length()+IP.length()+PH.length()+BAT_V.length()+GPS_JSON.length(); 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
 ...
 //  SIM5320.println("\"}");
///////////////////////////////////////////////////////////////   
   SIM5320.print("[{\"imei\":\"012813005352598");
   delay(50);
  // SIM5320.print(IMEI);
   delay(50);
   SIM5320.print("\",\"ip\":\"");
   ...
   SIM5320.print(BAT_V);
   delay(50);
   SIM5320.print(",\"kpiunitmeasure\":\"ph\",\"nmea\":\"");
   delay(50);
   SIM5320.print(GPS_JSON);
   delay(50);
   SIM5320.println("\"}]");  
...
void GPS() {
   ...
   COPIA_GPS();
   SIM5320.println(F("AT+CGPSINFOCFG=1,2"));
    delay(800);
      GPS_JSON=GPS_BUFFER;
...
{
  digitalWrite(5, HIGH);
  delay(1000);//                                     //ENCIENDE EL SIM5320
  digitalWrite(5, LOW);
  delay(1000);
 } 
////////////////////
