                                                                  ...
                                                                  if (BODY[i] == 0x0D) {
                                                                       ...
                                                                       CELULAR_ALTA_STRING=CELULAR_ALTA;                               
                                                                                                                     ...
                                                                                                                     if (CARACTER_INVALIDO_MSJ == false && ERROR_LENGTH_MSJ == false) { 
                                                                                                                                  ...
                                                                                                                                  for(int x=0;x<3;x++){             //NUMERO DE RESGISTROS (NUMEROS DE REGISTROS)
                                                                                                                                 
                                                                                                                                    
                                                                                                                                                      if(EEPROM.read(x) == 0 && ADRR_EEPROM_OCUPADO <=3){
                                                                                                                   ...
                                                                                                                   /*    else { 
                                                                                                                       ...
                                                                                                                       while(REG_100 <= 2){                                     //NUMERO DE RESGISTROS (NUMEROS DE REGISTROS)
                                                                                                                       //BARRIDO_100++;
                                                                                                                       REG_100++;
                                                                                                                       y=0;                              
                                                                                                                                                      if(EEPROM.read(REG_100) != 0){
                                                                                                                                                      ADRR_EEPROM_OCUPADO++;  
                                                                                                                                                      if(ADRR_EEPROM_OCUPADO == 3){                     //
                                                                                                                                                      SIN_MEMORIA(); 
