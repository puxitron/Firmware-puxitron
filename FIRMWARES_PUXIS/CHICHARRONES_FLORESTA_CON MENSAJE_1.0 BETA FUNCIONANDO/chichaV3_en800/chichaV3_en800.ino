...
SoftwareSerial SIM900(14,15);          //(RX,TX)
...
void FTP()                                                         // FUNCION QUE 
{
  ...
  SIM900.println(F("AT+FTPGETNAME=\"123.txt\""));                                    //MUESTRA LA IP 
  delay(1000);
...
void TIO()
{
  ...
  //delay(1000);
  SIM900.print("AT+CMGS=\"+522292293630\"\r");   //phone number to which you want to send sms
  delay(1000);
