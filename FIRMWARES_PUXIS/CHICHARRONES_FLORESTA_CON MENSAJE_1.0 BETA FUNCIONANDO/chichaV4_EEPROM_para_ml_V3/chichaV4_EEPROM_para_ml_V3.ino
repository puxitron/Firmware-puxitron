...
boolean CARACTER_ERRR_MSJ= false;
                          ...
                          for (int i = 9; i < 19; i++) {
                                      CELULAR[i - 9] = BUFFER_USART2[i];
                                                          ...
                                                          for (int i = 47; i < 71; i++) {
                                                            ...
                                                            if (strcasestr(BODY, "Alta@:")) {              ////////////////////////////////MECANISMO DE ALTA/BAJA DE CUALQUIER NUMERO INCLUYE VALIDACION 10DIGITOS(ONLY NUMBERS)
                                                            ...
                                                            for (int i = 7; i < 20; i++) {
                                                                  ...
                                                                  if (BODY[i] == 0x0D) {
                                                                       ...
                                                                       CELULAR_ALTA_STRING=CELULAR_ALTA;                               
                                                                                                                       ...
                                                                                                                       if (CARACTER_ERRR_MSJ == true) { 
                                                                                                                            CARACTER_ERRR_MSJ=false;
                                                                                                                                  ALTA_INCORRECTA(); 
                                                                                                                       ...
                                                                                                                       while(REG_100 < 4){                                     //NUMERO DE RESGISTROS (NUMEROS DE REGISTROS)
                                                                                                                       REG_100++;
                                                                                                                       y=0;                              
                                                                                                                                                      if(INDEX_EEPROM = EEPROM.read(REG_100) == 0x00){
                                                                                                                                                             y+=REG_100;
                                                                                                                                                                                                  for(int k=0;k<10;k++){
                                                                                                                                                      ...
                                                                                                                                                      //asm volatile ("jmp 0");                         
                                                                                                                                                                                              ...
                                                                                                                                                                                              } //IF QUE BUSCA SI EL INDEX EEPROM TIENE UN CARACTER ESCRITO
...
void ALTA_ALARMA()
{
  ...
  delay(50);
  SIM800.print(3-ADRR_EEPROM_OCUPADO);           //SMS body
  delay(50);
